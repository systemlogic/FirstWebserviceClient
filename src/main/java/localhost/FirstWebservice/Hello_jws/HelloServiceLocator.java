...
public class HelloServiceLocator extends org.apache.axis.client.Service implements localhost.FirstWebservice.Hello_jws.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8090/FirstWebservice/Hello.jws";
    ...
    public localhost.FirstWebservice.Hello_jws.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.FirstWebservice.Hello_jws.HelloSoapBindingStub _stub = new localhost.FirstWebservice.Hello_jws.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.FirstWebservice.Hello_jws.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.FirstWebservice.Hello_jws.HelloSoapBindingStub _stub = new localhost.FirstWebservice.Hello_jws.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8090/FirstWebservice/Hello.jws", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8090/FirstWebservice/Hello.jws", "Hello"));
        }
